				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
		                ...
		                if ($user->row()->level == 's_admin') { ?>
										<li class="<?php if ($sub_menu == "pengguna") { echo 'active';}?>"><a href="users/pengguna"><i class="icon-users"></i> Pengguna</a></li>
										<?php
										}?>
								...
								<li class="<?php if ($sub_menu == "memo") { echo 'active';}?>"><a href="users/memo"><i class="icon-file-text2"></i> <span>Memo</span></a></li>
